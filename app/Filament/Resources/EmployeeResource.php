...
class EmployeeResource extends Resource
{
    ...
    {
        return ['user.middle_name', 'user.first_name', 'user.name', 'user.last_name', 'user.email'];
    }
    public static function getGlobalSearchResultDetails(Model $record): array
    {
        return [
            // 'User Name' => $record->user->name,
            'First Name' => $record->user->first_name,
            'Middle Name' => $record->user->middle_name,
            'Last Name' => $record->user->last_name,
